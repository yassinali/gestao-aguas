...
export default function MeterReadingsPage() {
  ...
  const handleReadingChange = async (
    ...
    <div className="p-8 space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Seleccione um contador e insira a leitura actual
          </CardDescription>
        </CardHeader>
        <CardContent>
          {isLoading ? (
            ...
            <div className="space-y-6">
                    ...
                    {meters
                      ...
                      .map((meter) => (
                        <SelectItem key={meter.id} value={meter.id}>
                          {meter.meterNumber} - {meter.contract.client.name}
                        </SelectItem>
                      ))}
                  </SelectContent>
                </Select>
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <p className="font-semibold">
                        {selectedMeter.contract.client.name}
                      </p>
                    </div>
                    <div>
              ...
              <div>
                ...
                {selectedMeter && (
                  <p className="text-xs mt-1">
                    Mínimo: {selectedMeter.lastReading || 0} m³
                  </p>
                )}
              </div>
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      <div>
                        ...
                        <p className="text-2xl font-bold text-primary">
                          {calculatedValues.consumption} m³
                        </p>
                      </div>
                      <div>
                        <p className="text-xs font-semibold uppercase">
                        ...
                        <p className="text-lg font-semibold">
                          {calculatedValues.baseCharge.toFixed(2)} MT
                        </p>
                      </div>
                      <div>
                        <p className="text-xs font-semibold uppercase">
              ...
              {selectedMeter &&
                currentReading &&
                Number.parseFloat(currentReading) <
                  selectedMeter.lastReading && (
                  <Alert variant="destructive">
                    <AlertCircle className="h-4 w-4" />
                    <AlertDescription>
                      A leitura actual não pode ser menor que a leitura anterior
                      ({selectedMeter.lastReading} m³)
                    </AlertDescription>
                  </Alert>
                )}
