...
export default function CompanyPage() {
  ...
  const handleSave = async () => {
    ...
    if (
      ...
      toast(
        "Indique o nome do banco e número de conta para transferência bancária"
      );
      return;
    }
  ...
  if (isLoading) {
    return (
      <div className="p-8 text-neutral-medium">A carregar definições...</div>
    );
  }
  ...
  if (!settings) {
    return (
      <div className="p-8 text-neutral-dark">
        Falha ao carregar definições da empresa
      </div>
    );
  }
  ...
  const calculatedCharge =
    Number(settings.minimumCharge) +
    (exampleConsumption > settings.minimumCubicMeters
      ? (exampleConsumption - Number(settings.minimumCubicMeters)) *
        Number(settings.pricePerCubicMeter)
      : 0);
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-neutral-medium mt-2">
            Gerir informação da empresa, preços e métodos de pagamento
          </p>
        </div>
        {hasChanges && (
        ...
        <TabsContent value="pricing" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Definir preços da água e encargos mínimos
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleSettingsChange({
                        ...settings,
                        minimumCharge: Number.parseFloat(e.target.value) || 0,
                      })
                    }
                    placeholder="300"
                  />
                  <p className="text-xs text-neutral-medium mt-1">
                    Cobrado para consumo abaixo do mínimo
                  </p>
                </div>
                <div>
                  ...
                  />
                  <p className="text-xs text-neutral-medium mt-1">
                    Limite para aplicar encargo mínimo
                  </p>
                </div>
              </div>
              <div>
                ...
                />
                <p className="text-xs text-neutral-medium mt-1">
                  Cobrado para consumo acima do mínimo
                </p>
              </div>
              ...
              <Alert className="bg-blue-50 border-blue-200">
                ...
                <AlertDescription className="text-blue-800 text-sm">
                  <strong>Lógica de Preços:</strong> Se consumo ≤{" "}
                  {settings.minimumCubicMeters}m³, cobrar{" "}
                  {settings.minimumCharge}MT. Caso contrário, cobrar{" "}
                  {settings.minimumCharge}MT + ({"{consumo}"} -{" "}
                  {settings.minimumCubicMeters}) × {settings.pricePerCubicMeter}
                  MT
                </AlertDescription>
              </Alert>
            </CardContent>
        ...
        <TabsContent value="payments" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configurar métodos de pagamento aceites para clientes
              </CardDescription>
            </CardHeader>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-neutral-medium">
                      Aceitar pagamentos em dinheiro no balcão
                    </p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-3">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      handleSettingsChange({
                        ...settings,
                        acceptBankTransfer: checked as boolean,
                      })
                    }
                  />
                  <div>
                    ...
                    <p className="text-xs text-neutral-medium">
                      Aceitar transferências bancárias diretas
                    </p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      handleSettingsChange({
                        ...settings,
                        acceptEmola: checked as boolean,
                      })
                    }
                  />
                  <div>
                ...
                <div className="flex items-center gap-3">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      handleSettingsChange({
                        ...settings,
                        acceptMpesa: checked as boolean,
                      })
                    }
                  />
                  <div>
                ...
                <div className="pt-4 border-t space-y-4">
                  ...
                  <Alert className="bg-amber-50 border-amber-200">
                    ...
                    <AlertDescription className="text-amber-800 text-sm">
                      Estes detalhes serão apresentados aos clientes para
        ...
        <TabsContent value="preview" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Reveja as definições e preços da empresa
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 bg-neutral-light rounded-lg">
                  <p className="text-xs font-semibold text-neutral-medium uppercase">
                    Nome da Empresa
                  </p>
                  ...
                  <div className="bg-blue-50 p-4 rounded-lg space-y-2">
                    ...
                    {exampleConsumption > settings.minimumCubicMeters && (
                      <div className="flex justify-between">
                        <span>
                          Adicional (
                          {exampleConsumption -
                            Number(settings.minimumCubicMeters)}
                          m³ × {Number(settings.pricePerCubicMeter)}MT):
                        </span>
                        <span className="font-semibold">
                          {(
                            (exampleConsumption -
                    ...
                    <div className="border-t border-blue-200 pt-2 flex justify-between font-bold text-lg">
                      ...
                      <span className="text-primary">
                        {(Number(calculatedCharge) || 0).toFixed(2)}MT
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <div className="border-t pt-6">
                ...
                {acceptedMethods.length > 0 ? (
                  ...
                  <p className="text-neutral-medium text-sm">
                    Nenhum método de pagamento seleccionado
                  </p>
                )}
              </div>
